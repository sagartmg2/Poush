...
/* 
    normal synstax
    funciton <name>(parameter,parameter_2){
        // DO SOME TASK 
        return <variable>
...
// let differenciate = (num1, num2) => {
//     return num1 - num2
// }

let differenciate = (num1, num2) => num1 - num2


let result = differenciate(10, 5)
// differenciate(20, 5)
console.log({ result });


function printPostInfo(index, key) {
    // console.log(posts[index].title);
    console.log(posts[index][key]);
}

// printPostInfo(0, "title")
// printPostInfo(0, "id")
// printPostInfo(2, "id")
// printPostInfo(0, "userId")
